...
//print_r($header);
$this->load->view('store/header-store',$header);
?>
<!-- CONTENT -->
<div id="wrapper">
    <!-- LEFT -->
...
<div id="rightContent" class="floatLeft">
    ...
    <div id="content-box">
        <br />
        <img src="<?=$header['application']['baseurl']?>skin/default/images/ajax-loading.gif">
        <script language="JavaScript">
            $('#content-box').load('<?=$header['application']['siteurl']?>content/getcontentbyprovider/ajax/true/f_CONTENTPROVIDERID/<?=$navigation['urisegments']['cp']?>');
        </script>
    </div>
    <div class="h10px"></div>    
</div>
