        ...
        <div id="contentDetail">
            <div id="detailRight" class="floatLeft">
                ...
                <option value="12">12 bulan</option>';
                        ...
                        <div class="formRight">
                            <input name="f_USERIDCONTENT" value="<?=@$username?>" maxlength="25" size="25" readonly id="f_USERIDCONTENT" type="text" class="login" style="width:141px;"/></div>
                        <div class="clearfix"></div>
                        <div class="h5px"></div>
                        ...
                        <div class="formRight"><input name="f_EMAIL" value="<?=$email?>" readonly maxlength="50" size="25" id="f_EMAIL" type="text" class="login" style="width:141px;"/></div>
                        <div class="clearfix"></div>
