<div id="headerContent">
    <div id="contentNav" class="dirnavs">
        <ul>
            <li><a href="#"><?=@$content['categoryname']?></a></li>
        </ul>
    </div>
        ...
        <table class="tb-list-box" width="100%" border="0px" cellpadding="10px" cellspacing="1px">
            ...
            foreach (array_keys($contentlist) as $key) {
                ...
                if ($contentlist[$key]['circlerating']==0)
                    ...
                    $billcaption= "Biaya Bulanan / ".$contentlist[$key]['circlerating']." Bulan";
                }
                echo '<td width="175px">
                <div class="content-description">
                        <span class="content-name">'.$contentlist[$key]['name'].'</span>
                        <span class="content-descript">'.$contentlist[$key]['shortdescript'].'</span>
                        <span class="content-attribute"><span class="content-tag">Tipe</span>'.$contentlist[$key]['category'].'
...
<div><img src="<?=$header['application']['baseurl']?>/skin/default/images/main_footer.png" width="629" height="9" alt="footer" /></div>
<script type="text/javascript">
